...
function Quiz() {
    ...
    if (loading) return <div style={{padding: '20px'}}>Loading questions from server...</div>;
        ...
        <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{ marginBottom: '30px', padding: '15px', border: '1px solid #ddd' }}>
                ...
                <input 
                    ...
                    value={userData.name} onChange={handleUserInfoChange}
                />
                <input 
                    style={{ display: 'block', width: '100%', padding: '8px' }}
                    type="email" name="email" placeholder="Email Address" 
                    value={userData.email} onChange={handleUserInfoChange}
                />
            </div>
            <hr />
            {questions.map((q) => (
